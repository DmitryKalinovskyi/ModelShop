...
namespace ModelShop.Migrations
{
    ...
    [Migration("20231225175337_OrderMigrationTotalPrice")]
    partial class OrderMigrationTotalPrice
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModelShop.Models.ClientFollower", b =>
                {
                    b.Property<int>("ClientFollowerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ClientFollowerId"));
                    ...
                    b.HasKey("ClientFollowerId");

                    b.HasIndex("FollowerID");

                    b.HasIndex("FollowingID");

                    b.ToTable("ClientFollowers");
                });
            ...
            modelBuilder.Entity("ModelShop.Models.ClientFollower", b =>
                {
                    b.HasOne("ModelShop.Models.Client", "Follower")
                        .WithMany("Followers")
                        .HasForeignKey("FollowerID");

                    b.HasOne("ModelShop.Models.Client", "Following")
                        .WithMany("Followings")
